    ...
    "$compile", "$timeout", function($compile, $timeout) {
      ...
      return {
        ...
        link: function($scope, element, attrs, formController) {
          ...
          $scope.hide = function($event, isWrappedInsideFilterBox) {
            if ($event != null) {
          ...
          if ($scope.showDateRangePickerOnly) {
            $scope.selection = $scope.model;
            $scope.$on('cancelReportFilter', function() {
              return $scope.hide(null, true);
            });
            $scope.$on('applyReportFilter', function() {
              return $scope.ok(null);
            });
          }
          _makeQuickList();
